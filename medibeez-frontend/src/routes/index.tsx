...
import { Bee, RoamingBee } from "@/components/Bee";
import { ModuleCard } from "@/components/ModuleCard";
import hero from "@/assets/hero-doctors.jpg";
import newsCardiology from "@/assets/news-cardiology.jpg";
import newsPediatrics from "@/assets/news-pediatrics.jpg";
import newsEndocrinology from "@/assets/news-endocrinology.jpg";
...
const news = [
  { tag: "Cardiology", date: "Apr 28, 2026", read: "4 min", title: "American Heart Association updates", excerpt: "A consolidated new evidence-based update was released by the AHA last month. The guidelines were extended...", img: newsCardiology },
  { tag: "Pediatrics", date: "Apr 22, 2026", read: "5 min", title: "Antibiotic prophylaxis in infants", excerpt: "An investigator-led randomized controlled open-label trial across multiple centers studied that...", img: newsPediatrics },
  { tag: "Endocrinology", date: "Apr 15, 2026", read: "6 min", title: "Insulin Icodec: A basal insulin analogue", excerpt: "A recent report released the effects of a comparative study between once-weekly basal insulin analogue...", img: newsEndocrinology },
  { tag: "Research", date: "Apr 10, 2026", read: "5 min", title: "Prevention of CVD in HIV patients", excerpt: "HIV brings an increased risk of cardiovascular diseases and the phase 3 trial administered pitavastatin...", img: newsResearch },
];
    ...
    <Layout>
      ...
      <section className="relative honeycomb-bg overflow-hidden">
        <div className="container mx-auto px-4 py-20 lg:py-28 grid lg:grid-cols-2 gap-12 items-center">
          ...
          <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.7, delay: 0.2 }} className="relative">
            ...
            <img src={hero} alt="Doctors collaborating on MediBeez" className="relative rounded-3xl shadow-glow w-full" />
      ...
      <section className="bg-muted/40 py-20">
        <div className="container mx-auto px-4">
          <div className="flex items-end justify-between flex-wrap gap-4">
            <div>
              <h2 className="text-2xl sm:text-3xl lg:text-2xl sm:text-3xl lg:text-4xl font-bold">Stay up-to-date with <span className="text-primary">Global Healthcare</span></h2>
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-brand p-10 md:p-14 text-white text-center min-h-[360px]">
          ...
          <h2 className="text-2xl sm:text-3xl lg:text-2xl sm:text-3xl lg:text-4xl font-bold">Ready to join our community?</h2>
